        ...
        <div id="template-mo-zay-hero-carousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="container">
                        <div class="row p-5">
                            <div class="mx-auto col-md-6 col-lg-6 order-lg-last text-center">
                                <img class="img-fluid mx-auto" src="../assets/Product Data/ivdrip2.png" style="width:70%;" alt="">
                            </div>
                            <div class="col-lg-6 mb-0 d-flex align-items-center">
                                <div class="text-align-left align-self-center">
                                    <h1 class="h1 text-success"><b>Git Well Soon</b> eCommerce</h1>
                                    <h3 class="h2">Your One-Stop Medical Shop</h3>
                                    <p>
                                        Discover the ultimate convenience in shopping for medical supplies with <b>Git Well Soon</b>. 
                                        From personal wellness essentials to specialized healthcare equipment, we've got you covered. 
                                        Whether you're at home, in a clinic, or part of a medical institution, we're here to simplify your medical supply procurement.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row p-5">
                            <div class="mx-auto col-md-8 col-lg-6 order-lg-last text-center">
                                <img class="img-fluid mx-auto" src="../assets/Product Data/support1.png" style="width:60%;" alt="">
                            </div>
                            <div class="col-lg-6 mb-0 d-flex align-items-center">
                                <div class="text-align-left">
                                    ...
                                    <p>
                                        At Git Well Soon, we're on a mission to empower individuals and healthcare professionals by offering a <strong>convenient and comprehensive 
                                            ...
                                            and we're committed to making this process as easy as possible for you.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="carousel-item">
                    <div class="container">
                        <div class="row p-5">
                            <div class="mx-auto col-md-8 col-lg-6 order-lg-last text-center">
                                <img class="img-fluid mx-auto" src="../assets/Product Data/hs5.png" style="width:70%;" alt="">
                            </div>
                            <div class="col-lg-6 mb-0 d-flex align-items-center">
                                <div class="text-align-left">
                                    ...
                                    <p>
                                        ...
                                        of quality medical supplies at your fingertips.
                                    </p>
                                </div>
                            </div>
                        </div>
